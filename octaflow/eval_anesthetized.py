...
config_file = "configs_release/anesthetized_dataset/anesthetized_arguments_train_lr_2e-4_save_all_fold_0.txt"
arg_filename_with_prefix = '@' + config_file
# only parse the args defined in this file,
# and ignore the args which are only defined in the config file.
# args = parser.parse_args([arg_filename_with_prefix])
args = parser.parse_known_args([arg_filename_with_prefix])[0]
args.checkpoint_path = "ckpt/anesthetized_fold_0_model"
