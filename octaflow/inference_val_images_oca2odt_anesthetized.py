...
save_dir = "../pred_val_images/anesthetized_dataset/fold_0/lr_2e-4"
dataset_root = "../datasets_release/anesthetized_dataset"
val_imgs_txt = "../data_splits_k_fold_release/anesthetized_dataset/anesthetized_dataset_filepaths_test_fold_0.txt"
